...
export default function Home() {
  ...
  const features = [
    { 
      ...
      title: 'Free Shipping', 
      desc: '100% dedicated delivery' 
    },
    { 
      icon: <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path>, 
      title: 'Secure Payment', 
      desc: '100% data protection' 
    },
    { 
    ...
    <div style={{ minHeight: '100vh', backgroundColor: colors.background, fontFamily: '"Segoe UI", Roboto, sans-serif' }}>
      ...
      <div style={{ position: 'relative', height: '600px', display: 'flex', alignItems: 'center', padding: '0 5%', backgroundImage: 'url("https://images.unsplash.com/photo-1483985988355-763728e1935b?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80")', backgroundSize: 'cover', backgroundPosition: 'center top' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '650px', textAlign: 'left' }}>
          <span style={{ backgroundColor: '#eff6ff', color: colors.primary, padding: '6px 16px', borderRadius: '20px', fontSize: '13px', fontWeight: 'bold', display: 'inline-block', marginBottom: '25px' }}>New Collection 2026</span>
          <h1 style={{ fontSize: '64px', fontWeight: '900', color: '#0f172a', lineHeight: '1.1', margin: '0 0 25px 0', letterSpacing: '-1.5px' }}>Discover Your Authentic Style</h1>
          <p style={{ fontSize: '18px', color: '#475569', lineHeight: '1.6', marginBottom: '40px', maxWidth: '500px' }}>Experience premium shopping with the latest fashion trends for men and women. Express your personal style with confidence.</p>
